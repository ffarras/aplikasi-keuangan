...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            <div>
                <h2 class="text-white pb-2 fw-bold">Tambah Reimburse</h2>
            </div>
    ...
    <div class="row mt--2">
        <div class="col-md-12">
            <div class="card full-height">
                <div class="card-body">
                    <form method="post" action="{{ route('hutang.store') }}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6"> 
                                ...
                                <div class="form-group{{ $errors->has('bukti') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="file" name="bukti[]" id="input-bukti" class="form-control-file form-control-alternative{{ $errors->has('bukti') ? ' is-invalid' : '' }}" placeholder="{{ __('Bukti') }}" value="{{ old('bukti') }}" multiple>
                            ...
                            <div class="col-md-12">
                                <div class="form-group{{ $errors->has('catatan') ? ' has-danger' : '' }}">
                                    <div class="mt-2 mb-2">Catatan</div>
