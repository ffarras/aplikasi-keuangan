    ...
    <div class="row mt--2">
        <div class="col-md-12">
            <div class="card full-height">
                <div class="card-body">
                    <form method="post" action="{{ route('pemasukan.update', $pemasukan) }}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group{{ $errors->has('tanggal') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="tanggal" id="input-tanggal" class="form-control form-control-alternative{{ $errors->has('tanggal') ? ' is-invalid' : '' }}" placeholder="{{ __('Tanggal') }}" value="{{ $pemasukan->tanggal }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('account') ? ' has-danger' : '' }}">
                                    ...
                                    <select name="account" id="input-account" class="form-control" required>
                                        @foreach ($account as $acc)
                                            @if ( $pemasukan->account_id == $acc->id )
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('aktivitas') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="aktivitas" id="input-aktivitas" class="form-control form-control-alternative{{ $errors->has('aktivitas') ? ' is-invalid' : '' }}" placeholder="{{ __('Aktivitas') }}" value="{{ $pemasukan->aktivitas }}" required>
                                ...
                                <div class="form-group{{ $errors->has('jumlah') ? ' has-danger' : '' }}">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="jumlah" id="input-jumlah" class="form-control form-control-alternative{{ $errors->has('jumlah') ? ' is-invalid' : '' }}" placeholder="{{ __('Jumlah') }}" value="{{ str_replace( ',', '', $pemasukan->jumlah) }}"required>
                                    ...
                                    @if ($pemasukan->bukti)
                                        ...
                                        <label class="imagecheck">
                                            ...
                                            <figure class="imagecheck-figure">
                                                <img src="/uploads/pemasukan/{{ $foto }}" alt="bukti" width="100px">
                                            </figure>
                                        </label>
                                        @endforeach
                            ...
                            <div class="col-md-12">
                                <div class="form-group{{ $errors->has('catatan') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="catatan" id="input-catatan" class="form-control form-control-alternative{{ $errors->has('catatan') ? ' is-invalid' : '' }}" placeholder="{{ __('Catatan') }}" value="{{ $pemasukan->catatan }}">
