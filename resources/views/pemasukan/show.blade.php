...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            <div>
                <h2 class="text-white pb-2 fw-bold">Detail Pemasukan</h2>
            </div>
            <div class="ml-md-auto py-2 py-md-0">
                <a href="/pemasukan" class="btn btn-white btn-border btn-round" style="border: 2px solid white !important;">
                Kembali
                </a>
            </div>
        </div>
            ...
            <div class="card full-height">
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                ...
                                <thead>
                                    ...
                                    <td>: {{ $pemasukan->account->nama }}</td>
                                    </tr>
                                </thead>
                                <thead>
                                    <tr>
                                    <th width="40px">Aktivitas</th>
                                    <td>: {{ $pemasukan->aktivitas }}</td>
                                    </tr>
                                </thead> 
                                <thead>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        @if ($pemasukan->bukti)
                                            @foreach(json_decode($pemasukan->bukti) as $foto) 
                                                ...
                                                <img class="img" src="/uploads/pemasukan/{{ $foto }}" alt="bukti" width="250px">
                                                </button>
                                            @endforeach
                                        @else
                                            Bukti kosong
                    ...
                    <div class="text-center">
                        <a href="{{ route('pemasukan.edit', $pemasukan) }}" class="btn btn-warning">
                            Edit
                        </a>
                    </div>
                </div>
