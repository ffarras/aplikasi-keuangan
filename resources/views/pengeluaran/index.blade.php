...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            <div>
                <h2 class="text-white pb-2 fw-bold">Daftar Pengeluaran Bulan Ini</h2>
            </div>
            <div class="ml-md-auto py-2 py-md-0">
                <div class="dropdown">
                <a class="btn btn-white btn-border btn-round dropdown-toggle" style="border: 2px solid white !important;" href="#" role="button" id="dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="flaticon-circle"></i> Tambah Pengeluaran
                </a>

                    <div class="dropdown-menu" aria-labelledby="dropdown">
                        <a class="dropdown-item" href="{{ route('pengeluaran.create') }}">Pengeluaran Lunas</a>
                        <a class="dropdown-item" href="{{ route('hutang.create') }}">Reimburse</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        $('#basic-datatables').DataTable({
            ...
            // {
            //     extend: 'excelHtml5',
            //     title: 'Data Pengeluaran Azura Labs',
            //     message: '  ',
            //     exportOptions: {
            //         columns: [ 0, 1, 2, 3, 4, 5 ]
            //     },
            ...
            columns: [
                    ...
                    {data: 'account.nama', class: 'text-center', width: '110px'},
                    {data: 'kategori.kategori', class: 'text-center', width: '120px'},
