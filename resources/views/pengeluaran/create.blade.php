    ...
    <div class="row mt--2">
        <div class="col-md-12">
            <div class="card full-height">
                <div class="card-body">
                    <form method="post" action="{{ route('pengeluaran.store') }}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group{{ $errors->has('bukti') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="file" name="bukti[]" id="input-bukti" class="form-control-file form-control-alternative{{ $errors->has('bukti') ? ' is-invalid' : '' }}" required multiple>
                                ...
                                <div class="form-group{{ $errors->has('catatan') ? ' has-danger' : '' }}">
                                    <div class="mb-2 mt-2">Catatan</div>
