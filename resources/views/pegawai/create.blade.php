                                ...
                                @csrf
                                    <div class="pl-lg-4">
                                        ...
                                        <div class="form-group{{ $errors->has('jabatan') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="jabatan" id="input-jabatan" class="form-control form-control-alternative{{ $errors->has('jabatan') ? ' is-invalid' : '' }}" placeholder="{{ __('Jabatan') }}" value="{{ old('jabatan') }}" required>
